...
const messages = {
  en: {
    ...
    addEvent:'Add event', addExam:'Add exam', hideCompleted:'Hide completed', upcomingExams:'Upcoming exams', noUpcomingExams:'No upcoming exams.', noExamsNextMonth:'No exams in the next month.', showAllExams:'View all exams', collapseExams:'Collapse',
    ...
    displayAs:'Display as', pointsShort:'pts', gradingBasis:'Grading basis', weightedPercentage:'Weighted percentage', pointsBased:'Total points', weight:'Weight', myExpectedScore:'Expected Loss', contribution:'Final contribution',
    scorePlannerHint:'Enter the expected loss for each grading category. Daily Routine will calculate its contribution to the final course grade.',
    maxScore:'Max', targetScore:'Target', currentScore:'Current', maxTotal:'Maximum', targetTotal:'Target', currentEstimate:'Current estimate', gapToTarget:'To target', saveScorePlan:'Save score plan', addGradeCategoriesFirst:'Add grading categories on the Grade breakdown tab first.',
    projectedGrade:'Projected grade', targetGrade:'Target grade', difference:'Difference', aboveTarget:'Above target', belowTarget:'Below target', incompleteProjection:'Projection currently includes only categories with an expected loss.',
    ...
    sourceUnavailable:'Source text unavailable', parsedAnswer:'Summary', manuallyCorrected:'Manually corrected', holdOriginal:'Hold to view original',
    ...
    displaySettings:'Window and text', defaultWindowSize:'Default window size', editWindowSize:'Edit size', finishWindowSize:'Done', resizeWindowHint:'Resize the app window, then click Done to save its current size as the default.', fontSize:'Font size', fontSizeHint:'Adjust the size of text and interface content.',
    ...
    gradescopeEmail:'Gradescope email', gradescopePassword:'Gradescope password', saveAndLogin:'Save and log in', encryptedAccount:'Encrypted account', encryptionUnavailable:'Operating-system secure storage is unavailable.',
  ...
  zh: {
    ...
    addEvent:'添加事项', addExam:'添加考试', hideCompleted:'隐藏已完成', upcomingExams:'即将到来的考试', noUpcomingExams:'暂无即将到来的考试。', noExamsNextMonth:'未来一个月内没有考试。', showAllExams:'查看全部考试', collapseExams:'收起',
    ...
    displayAs:'显示方式', pointsShort:'分', gradingBasis:'计分方式', weightedPercentage:'加权百分比', pointsBased:'总分制', weight:'权重', myExpectedScore:'预期扣分', contribution:'最终贡献',
    scorePlannerHint:'为每个成绩类别填写预计扣分，软件会自动计算它对课程总评的贡献。',
    maxScore:'满分', targetScore:'目标', currentScore:'现在', maxTotal:'总满分', targetTotal:'总目标', currentEstimate:'当前估算', gapToTarget:'距目标', saveScorePlan:'保存分数规划', addGradeCategoriesFirst:'请先在“成绩构成”页添加成绩类别。',
    projectedGrade:'预计总评', targetGrade:'目标成绩', difference:'与目标差值', aboveTarget:'高于目标', belowTarget:'低于目标', incompleteProjection:'当前预计只包含已经填写预计扣分的类别。',
    ...
    sourceUnavailable:'原文证据暂不可用', parsedAnswer:'摘要', manuallyCorrected:'已人工校正', holdOriginal:'按住查看原文',
    ...
    displaySettings:'窗口与文字', defaultWindowSize:'默认窗口大小', editWindowSize:'编辑', finishWindowSize:'完成', resizeWindowHint:'拖动应用窗口到想要的大小，然后点击“完成”，当前尺寸将保存为默认值。', fontSize:'字体大小', fontSizeHint:'调节文字与界面内容的显示大小。',
    ...
    gradescopeEmail:'Gradescope 邮箱', gradescopePassword:'Gradescope 密码', saveAndLogin:'保存并登录', encryptedAccount:'已加密账号', encryptionUnavailable:'操作系统安全存储不可用。',
